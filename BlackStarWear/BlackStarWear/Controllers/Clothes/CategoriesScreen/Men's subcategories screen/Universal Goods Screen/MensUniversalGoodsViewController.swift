//
//  MensUniversalGoodsViewController.swift
//  BlackStarWear
//
...
class MensUniversalGoodsViewController: UIViewController {
...
extension MensUniversalGoodsViewController: UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "MensGoods", for: indexPath) as! MensUniversalGoodsCollectionViewCell
        cell.mensUniversalPriceLabel.text = String(universalPrice.dropLast(5)) + " руб."
        cell.mensUniversalNameLabel.text = universalName
