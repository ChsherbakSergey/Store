//
//  SendAsAGiftCertificateViewController.swift
//  BlackStarWear
//
...
class SendAsAGiftCertificateViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        //Design sendNowButton like it should look in the beginning
